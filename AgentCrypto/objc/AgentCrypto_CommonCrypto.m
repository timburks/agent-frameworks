/*!
 @file AgentCrypto_CommonCrypto.m
 ...
 */
#ifdef AgentCrypto_CommonCrypto
...
@implementation NSData (AgentCommonCrypto)
...
+ (NSData *) agent_AESKeyForPassword:(NSString *)password 
                          salt:(NSString *)salt {
...
- (NSData *) agent_aesEncryptedDataWithPassword:(NSString *) password salt:(NSString *) salt
{
    ...
    NSData *key = [isa agent_AESKeyForPassword:password salt:salt];
...
@interface AgentPublicRSAKey : NSObject
{
    SecKeyRef publicKey;
    BOOL valid;
}
...
@interface AgentPrivateRSAKey : NSObject 
{
    NSString *name;
    NSData *publicTag;
    NSData *privateTag;
...
@interface AgentPrivateRSAKey (Private)
- (BOOL) generateKeyPair:(NSUInteger)keySize;
@end

@implementation AgentPrivateRSAKey 
@synthesize valid;
...
@implementation AgentPublicRSAKey 
@synthesize valid;
