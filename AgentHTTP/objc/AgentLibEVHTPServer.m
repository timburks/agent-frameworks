...
{
    AgentLibEVHTPServer *server = (__bridge AgentLibEVHTPServer *) server_context;
...
@implementation AgentLibEVHTPServer
...
static void rad_response_helper(evhtp_request_t *req, AgentHTTPResponse *response)
{    
...
{
    AgentLibEVHTPServer *server = (__bridge AgentLibEVHTPServer *) arg;
...
- (void) addEventWithOperation:(NSOperation *) operation
{
    ...
    struct event *ev = event_new(evbase, -1, 0, cb_func, (__bridge void *) self);
