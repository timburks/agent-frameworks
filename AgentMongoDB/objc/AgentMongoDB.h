/*!
 @header AgentMongoDB.h
 @discussion Declarations for the AgentMongoDB component.
 ...
 */
@interface AgentMongoDBCursor : NSObject


/*! Step the cursor to the next object. */
- (BOOL) next;
/*! Get the AgentBSON representation of the current object. */
...
/*!
 ...
 @discussion AgentMongoDB instances are used to connect to, update, and query MongoDB databases.
 */
@interface AgentMongoDB : NSObject
